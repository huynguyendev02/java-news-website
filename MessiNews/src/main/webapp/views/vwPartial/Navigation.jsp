...
<nav>
    <form id="actionFrom" action="" method="post">
        <div class="collapse navbar-collapse d-flex justify-content-between px-4 py-3">
            <div class="d-flex align-items-center" style="width: 50%">
                <div class="pl-3">
                    <a name="logo" href="${pageContext.request.contextPath}/" style="text-decoration: none">
                        <img src="${pageContext.request.contextPath}/photos/logos/LogoMessi.png" alt=""
                             style="width: 70px">
                    </a>
                </div>
                <div class="pl-1 pt-3">
            ...
            <div class="d-flex">
                <div class="d-flex align-items-center mr-2" style="font-size: 18px">
                    <c:if test="${authUser.role >= 1 && authUser.role<=4}">
                        <b><i>Hi, ${authUser.full_name}</i></b>
                    </c:if>
                </div>
                    ...
                    <div class="dropdown-menu">
                        <c:choose>
                            ...
                            <c:when test="${authUser.role == 2}">
                                ...
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Account/Password">Thay
                                    đổi mật khẩu</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Writer/Upload">Đăng
                                    bài viết</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Writer/List">Danh sách
                                    bài viết</a>
                                <button class="dropdown-item"
                                        formaction="${pageContext.request.contextPath}/Account/Logout">Đăng xuất
                                </button>
                            ...
                            <c:when test="${authUser.role == 3}">
                                ...
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Account/Password">Thay
                                    đổi mật khẩu</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Editor/ListDraft">Danh
                                    sách các bản thảo</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Editor/ListComplete">Danh
                                    sách tất cả bài báo</a>
                                <button class="dropdown-item"
                                        formaction="${pageContext.request.contextPath}/Account/Logout">Đăng xuất
                                </button>
                            </c:when>
                            ...
                            <c:when test="${authUser.role == 4}">
                                ...
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Categories/ListCate">Quản lý chuyên
                                    mục nhỏ</a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Categories/ListPCate">Quản lý chuyên
                                    mục lớn</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Admin/Tags/List">Quản
                                    lý nhãn</a>
                                <a class="dropdown-item" href="${pageContext.request.contextPath}/Admin/Users/ListSub">Quản
                                    lý độc giả</a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Users/ListWriter">Quản lý phóng
                                    viên</a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Users/ListEditor">Quản lý biên tập</a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Users/ListAdmin">Quản lý Admin</a>
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/Admin/Articles/ListDraft">Quản lý các bản
                                    thảo</a>
                                <a class="dropdown-item"
