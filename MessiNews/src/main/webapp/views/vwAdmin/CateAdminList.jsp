            ...
            <div class="d-flex justify-content-center bgColorGray">
                ...
                <div style="width: 70%; background-color: white" class="m-4 p-3">
                    <div class="d-flex justify-content-between">
                        <h4>Danh sách các chuyên mục nhỏ</h4>
                        <a href="${pageContext.request.contextPath}/Admin/Categories/AddCate"
                           class="mx-3 px-3 btn btn-outline-success"
                           style="border-radius: 20px" type="button">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                            Thêm chuyên mục nhỏ mới
                        </a>
                    </div>
                        ...
                        <table class="w-100" cellpadding="5px">
                            ...
                            <c:forEach items="${allCategories}" var="c">
                                <tr>
                                    <td>${c.id}</td>
                                    <td align="center">
                                        <a href="${pageContext.request.contextPath}/Admin/Categories/EditCate?id=${c.id}">
                                                ${c.name_category}
                                        </a>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <button type="submit" onclick="confirmDelete(event)"
                                                formaction="${pageContext.request.contextPath}/Admin/Categories/DeleteCate?idCate=${c.id}"
