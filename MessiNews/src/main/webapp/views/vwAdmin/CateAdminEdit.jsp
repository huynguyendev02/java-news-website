...
<jsp:useBean id="cate" scope="request" type="com.messi.king.messinews.models.Categories"/>
        ...
        <form id="form" action="" method="post">
            <div class="d-flex justify-content-center bgColorGray">
                ...
                <div style="width: 70%; background-color: white" class="m-4 p-3">
                    ...
                    <hr>
                    <h5>Đang chỉnh chuyên mục đề: ${cate.name_category}</h5>
                    <br>
                    <label for="nameCate">Tên chủ đề</label>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <c:forEach items="${allPCategories}" var="c">
                                <a class="dropdown-item"
                                   onclick="choosePCat('${pageContext.request.contextPath}/Admin/Categories/EditCate?idCate=${cate.id}&idPCate=${c.id}','${c.name_parent_cate}')">${c.name_parent_cate}</a>
                            </c:forEach>
                        </div>
                    </div>
                    <hr>
                    <div id="save" align="end">
                        ...
                        <button class="btn btn-success" type="submit" formaction="${pageContext.request.contextPath}/Admin/Categories/EditCate?idCate=${cate.id}&idPCate=${cate.parent_cate_id}">
